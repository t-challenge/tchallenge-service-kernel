...
import ru.tchallenge.service.kernel.domain.event.category.EventCategory;
import ru.tchallenge.service.kernel.domain.event.category.EventCategoryBootstrap;
import ru.tchallenge.service.kernel.domain.event.category.EventCategoryRepository;
import ru.tchallenge.service.kernel.domain.event.status.EventStatus;
import ru.tchallenge.service.kernel.domain.event.status.EventStatusBootstrap;
import ru.tchallenge.service.kernel.domain.event.status.EventStatusRepository;
import ru.tchallenge.service.kernel.domain.forum.Forum;
import ru.tchallenge.service.kernel.domain.maturity.Maturity;
import ru.tchallenge.service.kernel.domain.maturity.MaturityBootstrap;
...
import ru.tchallenge.service.kernel.domain.specialization.SpecializationBootstrap;
